...
public class UpdateChecker {
    ...
    public static void check(String thisVersion){
        try{
            URL u=new URL("https://raw.githubusercontent.com/Plodelta/ploria/master/README.md");
            ...
            while((Line=br.readLine())!=null){
                Bukkit.getServer().getConsoleSender().sendMessage("[신들의 전쟁] "+ChatColor.AQUA+"최신 버전은 "+Line+"입니다.");
